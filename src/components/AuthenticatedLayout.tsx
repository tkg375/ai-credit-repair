...
const sections: { label: string; items: NavEntry[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/pricing", label: "Upgrade", key: "pricing", icon: <Icon d="M13 10V3L4 14h7v7l9-11h-7z" /> },
    ],
  },
];
...
export function AuthenticatedLayout({
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-slate-50 to-white text-slate-900">
      ...
      {/* Mobile top bar */}
      <div className="md:hidden fixed top-0 left-0 right-0 z-30 flex items-center justify-between px-4 py-3 bg-white border-b border-slate-200">
