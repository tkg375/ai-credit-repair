    ...
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <footer className="border-t border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
          ...
          <p className="text-center text-xs text-slate-400 mt-4">&copy; {new Date().getFullYear()} Credit 800. All rights reserved. Not a credit repair organization. Educational content only.</p>
        </div>
      </footer>
    </div>
  );
